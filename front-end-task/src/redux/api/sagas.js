...
const api1 = async (numero_conto_corrente, tipologia) => {
    const response = await axios.post("https://staging-api.bpoint.store/api/sepafin/freeBookBollettini/codiceFiscaleRequired", {
...
export function* firstApiFetch({ payload: { numero_conto_corrente, tipologia } }) {
